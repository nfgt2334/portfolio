...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <h1 className="text-5xl font-extrabold text-center mt-8 mb-12 tracking-tight">
...
const Card = ({ href, label, Icon }: CardProps) => (
  <Link
    href={href}
    className="flex flex-col items-center justify-center py-12 px-6 border rounded-3xl shadow-md hover:shadow-lg transition-all hover:bg-slate-50"
  >
